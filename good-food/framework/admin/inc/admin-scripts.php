...
function good_food_admin_register($hook) {
	...
	wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
		'clear' => 					__('Clear', 'good-food'),
		'clearAriaLabel' => 		__('Clear color', 'good-food'),
		'defaultLabel' => 			__('Color value', 'good-food'),
		'defaultString' => 			__('Default', 'good-food'),
		'defaultAriaLabel' => 		__('Select default color', 'good-food'),
		'pick' => 					__('Select Color', 'good-food'),
	) ); 
